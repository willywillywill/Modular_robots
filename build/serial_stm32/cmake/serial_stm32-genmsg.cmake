...
set(MSG_I_FLAGS "-Iserial_stm32:/ros_ws/src/serial_stm32/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_custom_target(_serial_stm32_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_stm32" "/ros_ws/src/serial_stm32/msg/Verter.msg" ""
)
...
### Generating Messages
_generate_msg_cpp(serial_stm32
  "/ros_ws/src/serial_stm32/msg/Verter.msg"
  "${MSG_I_FLAGS}"
  ""
...
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_dependencies(serial_stm32_generate_messages_cpp _serial_stm32_generate_messages_check_deps_${_filename})
...
### Generating Messages
_generate_msg_eus(serial_stm32
  "/ros_ws/src/serial_stm32/msg/Verter.msg"
  "${MSG_I_FLAGS}"
  ""
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_dependencies(serial_stm32_generate_messages_eus _serial_stm32_generate_messages_check_deps_${_filename})
...
### Generating Messages
_generate_msg_lisp(serial_stm32
  "/ros_ws/src/serial_stm32/msg/Verter.msg"
  "${MSG_I_FLAGS}"
  ""
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_dependencies(serial_stm32_generate_messages_lisp _serial_stm32_generate_messages_check_deps_${_filename})
...
### Generating Messages
_generate_msg_nodejs(serial_stm32
  "/ros_ws/src/serial_stm32/msg/Verter.msg"
  "${MSG_I_FLAGS}"
  ""
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_dependencies(serial_stm32_generate_messages_nodejs _serial_stm32_generate_messages_check_deps_${_filename})
...
# add dependencies to all check dependencies targets
get_filename_component(_filename "/ros_ws/src/serial_stm32/msg/Verter.msg" NAME_WE)
add_dependencies(serial_stm32_generate_messages_py _serial_stm32_generate_messages_check_deps_${_filename})
